...
const ControlCenterController_1 = tslib_1.__importDefault(require("@controller/ControlCenterController"));
const router = express_1.Router();
const userDao = new UserDao_mock_1.default();
router.use('/news', NewsController_1.default);
router.use('/control-center', ControlCenterController_1.default);
